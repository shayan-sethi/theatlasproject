...
const DigitalSerenity = () => {
  ...
  useEffect(() => {
    ...
    const handleWordMouseEnter = (e: Event) => {
  ...
  useEffect(() => {
    const elements = Array.from(document.querySelectorAll<HTMLElement>('.floating-element-animate'));
